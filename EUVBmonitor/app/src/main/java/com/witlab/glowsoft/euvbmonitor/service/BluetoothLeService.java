...
public class BluetoothLeService extends Service {
    ...
    private MainActivity masterRef;
    public void setMaster(MainActivity mainActv){
        masterRef = mainActv;
    }
    ...
    private void broadcastUpdate(final String action, final BluetoothGattCharacteristic characteristic) {
        ...
        Log.i(TAG, "packet received : " + PacketManager.byteArrayToHex(data));
