...
public class DataRepository_old {
    ...
    private DataRepository_old() {
        makeDateObjTable();
//        initTimeTable();
    }

    private static class SingletonHolder {
        private static final DataRepository_old instance = new DataRepository_old();
    }

    public static DataRepository_old getInstance() {
