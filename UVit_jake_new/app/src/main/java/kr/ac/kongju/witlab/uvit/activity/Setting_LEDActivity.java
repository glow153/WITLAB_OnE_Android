...
import kr.ac.kongju.witlab.uvit.fragment.FragmentSetting_LED;

/**
 * Created by user on 2016-08-25.
 */
public class Setting_LEDActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabLayout tabLayout = (TabLayout) findViewById(R.id.led_tabs);
        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.ic_tab_setting_led).setCustomView(view));
...
//        tabLayout.setTabMode(TabLayout.MODE_FIXED);
        ...
        final ViewPager viewPager = (ViewPager) findViewById(R.id.led_container);
    ...
    private class PagerAdapter extends FragmentStatePagerAdapter {
        ...
        public PagerAdapter(FragmentManager fm) {
            super(fm);
            list.add(new FragmentSetting_LED());
        }
