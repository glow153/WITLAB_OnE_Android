...
package kr.ac.kongju.witlab.dailycontrol.ble.service;
...
public class BluetoothLeService extends Service {
    ...
    public final static UUID UUID_ENTEC_SERVICE = UUID.fromString("0000FF00-0000-1000-8000-00805F9B34FB");
    public final static UUID UUID_ENTEC_WRITE_CHAR = UUID.fromString("0000FF01-0000-1000-8000-00805F9B34FB");
    public final static UUID UUID_ENTEC_READ_CHAR = UUID.fromString("0000FF02-0000-1000-8000-00805F9B34FB");
    ...
    private void setCustomUUID(BluetoothDevice device) {
        Log.d("BlueetoothLeService.setCustomUUID()","device name: " + device.getName());
        if (device.getName().equals("Bluno")) {
            service_uuid = UUID_BLUNO_NANO_SERVICE;
            write_char_uuid = UUID_BLUNO_NANO_WRITE_CHAR;
            read_char_uuid = UUID_BLUNO_NANO_READ_CHAR;
        } else if(device.getName().equals("KKET") ||
                device.getName().equals("Mum") ||
                device.getName().equals("HM-10")) { // HM-10
            service_uuid = UUID_HM10_SERVICE;
            write_char_uuid = UUID_HM10_WRITE_CHAR;
            read_char_uuid = UUID_HM10_READ_CHAR;
        }
        Log.d("BlueetoothLeService.setCustomUUID()","service UUID: " + service_uuid +
...
//        mWriteCharacteristic.setValue(value,android.bluetooth.BluetoothGattCharacteristic.FORMAT_UINT8,0);
    ...
    private String packetToStr(byte[] packet) {
